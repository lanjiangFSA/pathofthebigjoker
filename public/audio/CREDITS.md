...
Mixkit tracks/SFX: [Music Free License](https://mixkit.co/license/#musicFree) / [SFX Free License](https://mixkit.co/license/#sfxFree).  
Pass voice: Microsoft Edge Neural TTS via `edge-tts` (local generate).
...
| `sfx-finish.mp3` | 有人走完 | Mixkit winning coin |
| `sfx-round-end.mp3` | 本局结束 | Mixkit level completed |
